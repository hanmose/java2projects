...
public class UserDialogTest extends JFrame {
    public UserDialogTest() { // usage new
        setTitle("사용자정의 대화상자 실습");
        ...
        int option = JOptionPane.showOptionDialog(null, "가장 좋아하는 아이돌을 선택해 주세요.", "2025Idol",
                JOptionPane.OK_OPTION, JOptionPane.QUESTION_MESSAGE, null, strOptions, strOptions[0]);
